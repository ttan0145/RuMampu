...
Epic 1 完成报告见 [Epic 1 完成报告](docs/epic-1/EPIC_1_COMPLETION_REPORT.cn.md)。生产级 OCR、用户账户、跨设备同步以及 Epic 2/5 的正式化仍不在本轮完成范围；完整边界见 [Epic 1/2/5 实现矩阵](docs/EPIC_1_2_5_IMPLEMENTATION_MATRIX.cn.md)。
...
一个工作包只有在代码、测试、API schema 和受影响文档同步后才算完成。基础决策记录在 [ADR 0001](docs/adr/0001-foundation-and-api-contract.cn.md)。
